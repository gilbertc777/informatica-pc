resource "null_resource" "remote-exec-master-node" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            "export db_servicename=${oci_database_databases.databases.db_unique_name}.${oci_core_subnet.subnet.dns_label}.${oci_core_virtual_network.virtual_network.dns_label}.oraclevcn.com",
