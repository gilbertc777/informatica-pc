resource "null_resource" "remote-exec-master-node" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            "export db_port=1521",
            "export db_uname=c##usr7",
            "export db_servicename=${data.oci_database_databases.databases.databases.0.db_unique_name}.${oci_core_subnet.subnet.dns_label}.${oci_core_virtual_network.virtual_network.dns_label}.oraclevcn.com",
