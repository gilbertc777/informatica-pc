resource "null_resource" "remote-exec-master-node" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            "export master_db_password=${var.db_home_database_admin_password}",
            ...
            "export db_host_name=${var.db_hostname}",
            "export db_port=1521",
            "export db_uname=usr7",
            "export db_servicename=${var.db_home_database_pdb_name}.${oci_core_subnet.subnet.dns_label}.${oci_core_virtual_network.virtual_network.dns_label}.oraclevcn.com",
            "export domain_name=InfraDomain",
            "export node_name=${oci_core_instance.pc_instance.hostname_label}",
            "export grid_name=${var.grid_name}",
