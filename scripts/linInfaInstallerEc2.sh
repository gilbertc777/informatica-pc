...
then
 sh /home/opc/InfaEc2Scripts/generateTnsOra.sh $DB_SERVICENAME $DB_ADDRESS $DB_PORT &> /home/opc/InfaServiceLog.log
  ...
  echo "create user $DB_UNAME identified by $dbpass;" | sqlplus SYS/$2@$DB_SERVICENAME AS SYSDBA &>> /home/opc/InfaServiceLog.log
  ...
  echo "create user $REPO_USER identified by $dbpass;" | sqlplus SYS/$2@$DB_SERVICENAME AS SYSDBA &>> /home/opc/InfaServiceLog.log
